        ...
        if (depht == 0 || Tr.is_Leaf()){
            ...
            if (!INTERUPT){
                ...
                if (Tr.is_Leaf() && !INTERUPT){
                    MNKCell N = this.Board.MC.get(this.Board.MC.size()-1);
        ...
        for (int y=limit_up;y<=limit_dw;y++){
            ...
            switch(Casella){
                ...
                case FREE:
                    break;
                default:
                    throw new IllegalArgumentException("Stato Casella Inesistente");
